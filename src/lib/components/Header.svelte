<script lang="ts">
  ...
  const categories: { id: FilterCategory; label: string; icon: string }[] = [
    { id: 'all', label: 'Tümü', icon: 'M4 6h16M4 12h16M4 18h16' },
    { id: 'text', label: 'Metinler', icon: 'M4 6h16M4 12h10M4 18h7' },
    { id: 'image', label: 'Görseller', icon: 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z' },
    { id: 'pinned', label: 'Sabitlenenler', icon: 'M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z' },
  ];
</script>
...
>
  ...
  <div data-tauri-drag-region class="flex items-center justify-between mb-2">
    ...
    <div class="flex items-center space-x-2">
      <img src="/logo.png" alt="ClipVault" class="w-5 h-5 rounded-md shadow-xs object-cover select-none pointer-events-none shrink-0" title="ClipVault" />
      <div
    ...
    <div
      ...
      title="Pencereyi taşımak için basılı tutup sürükleyin"
    >
      <div
        data-tauri-drag-region
  ...
  {#if appMode === 'clipboard'}
    ...
    <div class="relative flex items-center mb-2.5">
      ...
      <input
        ...
        placeholder="Pano geçmişinde ara... (yön tuşları veya 1-9 ile seç)"
        onkeydown={(e) => {
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-1">
        ...
        <button
          ...
          style="color: {currentTheme ? currentTheme.secondaryTextColor : '#64748b'};"
          title="Pano Geçmişini Dışa Aktar (.md / .txt)"
        >
          <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
          </svg>
          <span class="text-[11px]">Dışa Aktar</span>
        </button>
        ...
        <button
          ...
          style="color: {currentTheme ? currentTheme.secondaryTextColor : '#64748b'};"
          title="Sabitlenmemiş geçmişi temizle"
        >
          <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
          </svg>
          <span class="text-[11px]">Temizle</span>
        </button>
      </div>
    </div>
  {/if}
